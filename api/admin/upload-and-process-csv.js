// Direct CSV upload and processing endpoint
// This completely bypasses Supabase storage and processes files directly
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Parse CSV content
    const deals = parseCSV(fileContent);
    ...
    return res.status(200).json({
      success: true,
      message: `CSV processed successfully! ${insertedCount} deals processed from ${file.originalFilename}`,
      details: {
