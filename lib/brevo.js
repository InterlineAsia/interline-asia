...
/**
 * Send a verification rejection email
 * @param {string} toEmail - User email
 * @param {string} toName - User name
...
async function sendRejectionEmail(toEmail, toName, reason = '') {
  const subject = "Verification Update - Interline Asia";
  ...
  const htmlContent = `
    ...
    <body style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <div style="text-align: center; margin-bottom: 30px;">
        <h1 style="color: #0C1E36; margin-bottom: 10px;">Verification Update</h1>
        <p style="color: #FF7F41; font-size: 18px; font-weight: 500;">Interline Asia Membership</p>
      </div>
      
      <div style="background: #f8f9fa; padding: 30px; border-radius: 8px; margin-bottom: 30px;">
        <h2 style="color: #0C1E36; margin-top: 0;">Hello ${toName},</h2>
        
        <p>Thank you for your interest in joining Interline Asia. We have reviewed your verification documents and unfortunately, we are unable to approve your membership at this time.</p>
        ...
        <p>If you believe this is an error or would like to resubmit your verification documents, please feel free to contact us. We're here to help and want to ensure all qualified travel industry professionals can access our exclusive deals.</p>
        
        <h3 style="color: #0C1E36;">Next Steps:</h3>
        <ul style="color: #555;">
          <li>📧 <strong>Contact Support:</strong> Reply to this email with any questions</li>
          <li>📄 <strong>Resubmit Documents:</strong> Upload clearer or additional verification documents</li>
          <li>🔍 <strong>Review Requirements:</strong> Ensure documents clearly show your travel industry employment</li>
        </ul>
        ...
        <p>We appreciate your understanding and look forward to potentially welcoming you to our community of travel professionals.</p>
      </div>
      
      <div style="border-top: 1px solid #eee; padding-top: 20px; text-align: center; color: #666; font-size: 14px;">
        <p>Questions? Contact us at <a href="mailto:admin@interlineasia.com" style="color: #FF7F41;">admin@interlineasia.com</a></p>
        <p style="margin-top: 20px;">
          <strong>Interline Asia</strong><br>
          Exclusive Cruise Deals for Travel Professionals<br>
          Asia Pacific Region
  ...
  const textContent = `
    Verification Update - Interline Asia
    
    Hello ${toName},
    
    Thank you for your interest in joining Interline Asia. We have reviewed your verification documents and unfortunately, we are unable to approve your membership at this time.
    
    ${reason ? `Reason: ${reason}` : ''}
    
    If you believe this is an error or would like to resubmit your verification documents, please feel free to contact us. We're here to help and want to ensure all qualified travel industry professionals can access our exclusive deals.
    
    Next Steps:
    - Contact Support: Reply to this email with any questions
    - Resubmit Documents: Upload clearer or additional verification documents
    - Review Requirements: Ensure documents clearly show your travel industry employment
    
    Upload new documents: https://www.interlineasia.com/dashboard
    
    We appreciate your understanding and look forward to potentially welcoming you to our community of travel professionals.
    
    Questions? Contact us at admin@interlineasia.com
...
/**
 * Send a verification approval email
 * @param {string} toEmail - User email
 * @param {string} toName - User name
 * @returns {Promise} - Promise resolving to email send result
 */
async function sendApprovalEmail(toEmail, toName) {
  const subject = "Welcome to Interline Asia - Verification Approved!";
  ...
  const htmlContent = `
    ...
    <body style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <div style="text-align: center; margin-bottom: 30px;">
        <h1 style="color: #0C1E36; margin-bottom: 10px;">🎉 Verification Approved!</h1>
        <p style="color: #FF7F41; font-size: 18px; font-weight: 500;">Welcome to Interline Asia</p>
      </div>
      
      <div style="background: #d4edda; border: 1px solid #c3e6cb; border-radius: 8px; padding: 20px; margin-bottom: 30px;">
        <h2 style="color: #155724; margin-top: 0;">Congratulations ${toName}!</h2>
        <p style="color: #155724; margin: 0;">Your verification has been approved and you now have full access to exclusive cruise deals!</p>
      </div>
      
      <div style="background: #f8f9fa; padding: 30px; border-radius: 8px; margin-bottom: 30px;">
        <p>Your travel industry credentials have been verified and you're now a full member of Interline Asia. You can now access:</p>
        
        <ul style="color: #555;">
          <li>🚢 <strong>Exclusive cruise deals</strong> with insider rates up to 70% off</li>
          <li>💰 <strong>Industry-only pricing</strong> not available to the public</li>
          <li>🎯 <strong>VIP access</strong> to luxury cruise experiences</li>
          <li>📧 <strong>Priority notifications</strong> for new deals and flash sales</li>
          <li>🏆 <strong>Member-only perks</strong> and special offers</li>
        </ul>
        
        <div style="text-align: center; margin: 30px 0;">
          <a href="https://www.interlineasia.com/public/deals.html" style="background: #28a745; color: white; padding: 15px 30px; text-decoration: none; border-radius: 6px; font-weight: 600; display: inline-block; margin-right: 10px;">
        ...
        <p>Start exploring our curated selection of cruise deals designed specifically for travel industry professionals like yourself.</p>
      </div>
      ...
      <div style="border-top: 1px solid #eee; padding-top: 20px; text-align: center; color: #666; font-size: 14px;">
        ...
        <p style="margin-top: 20px;">
          <strong>Interline Asia</strong><br>
          Your Gateway to Exclusive Cruise Deals<br>
          Asia Pacific Region
        </p>
      </div>
